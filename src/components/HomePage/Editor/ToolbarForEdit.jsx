...
const ToolBarForEdit = () =>{
    ...
    const toolbarLink = [
        ...
        {action: () => setQuote(), label: <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="M220-280q-50 0-85-35t-35-85q0-33 16-63t44-47l80-51v-159h160v240H300l-46 29q-14 9-14 26 0 17 12 29t28 12h140v104H220Zm420 0q-50 0-85-35t-35-85q0-33 16-63t44-47l80-51v-159h160v240H720l-46 29q-14 9-14 26 0 17 12 29t28 12h140v104H640Z"/></svg>},
        ...
        <div className="toolbar">
            <div className="group">
                {toolbarLink.map((link, index) => (
                    <div onMouseDown={(e) => {e.stopPropagation(); e.preventDefault(); link.action()}} key={index} className="toolbar-bttns">
                        {link.label}
                    </div>
                ))}
            </div>
