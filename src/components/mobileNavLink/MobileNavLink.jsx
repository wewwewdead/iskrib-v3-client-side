...
const MobileNavlink =({clickOpenSidebar}) =>{
    ...
    const navLinks = [
        {
            profileIcon:
            <div onClick={() => { if(!session) return openAuthModal(); clickOpenSidebar(); }} className='mobile-navlink-profile-container'>
                ...
                <div className='mobile-navlink-icon-container'>
                    {navLinks.map((link, index) => (
                        <div key={index}>
                            ...
                            {link.action && (
                                <div onClick={() => link.action(link.path)} className='mobile-navlink-icons' >
                                    {link.icon}
                                    {link.notifCount && (
